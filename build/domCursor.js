...
var DOMCursor, EmptyDOMCursor, MutableDOMCursor, chooseLower, chooseUpper, debug, differentLines, differentPosition, emptyDOMCursor, emptyRect, getClientRect, getTextPosition, isCollapsed, positioner, reject, selectRange, spareRange,
...
DOMCursor = (function() {
  ...
  DOMCursor.prototype.textPosition = function() {
    ...
    if (this.isEmpty()) {
      ...
      return (_ref = this.savedTextPosition) != null ? _ref : (this.savedTextPosition = getTextPosition(this.node, this.pos));
    }
  };
  ...
  DOMCursor.prototype.filterRange = function(startContainer, startOffset, endContainer, endOffset) {
    ...
    return this.addFilter(function(n) {
      ...
      return (startPos === 0 ? (startOffset <= (_ref = n.pos) && _ref <= endOffset) : startPos & Element.DOCUMENT_POSITION_FOLLOWING ? (endPos = endContainer.compareDocumentPosition(n.node), endPos === 0 ? n.pos <= endOffset : endPos & Element.DOCUMENT_POSITION_PRECEDING) : void 0) || 'quit';
    });
  };
  ...
  DOMCursor.prototype.backwardLine = function(goalFunc) {
    ...
    return (this.backwardWhile(function(n) {
      ...
      if (line === 1 && ((_ref = goalFunc(n.textPosition().left - 2)) === (-1) || _ref === 0)) {
        return 'found';
      } else {
        return line !== 2;
      }
...
getClientRect = function(r) {
  var comp, rect, rects, result, _i, _len;
