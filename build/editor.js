...
(function() {
  var BS, BasicEditingOptions, DEL, DOWN, DataStore, DataStoreEditingOptions, END, ENTER, HOME, LEFT, LeisureEditCore, Observable, PAGEDOWN, PAGEUP, RIGHT, TAB, UP, _to_ascii, blockText, defaultBindings, dragRange, getEventChar, htmlForNode, idCounter, isEditable, keyFuncs, last, link, maxLastKeys, modifiers, modifyingKey, posFor, root, selectRange, shiftKey, shiftUps, specialKeys,
    slice = [].slice,
    ...
    LeisureEditCore.prototype.handleDelete = function(e, s, forward, delFunc) {
      ...
      if (s.type === 'Caret') {
        ...
        if (!result) {
          ...
          return this.editBlocks(blocks, pos, 1, '', false);
        }
      } else {
