...
var BS, BasicOptions, DEL, DOWN, END, ENTER, EditCore, HOME, LEFT, PAGEDOWN, PAGEUP, RIGHT, TAB, UP, _to_ascii, defaultBindings, getEventChar, keyFuncs, last, link, maxLastKeys, modifiers, modifyingKey, root, selectRange, shiftKey, shiftUps, specialKeys;
...
EditCore = (function() {
  ...
  EditCore.prototype.moveForward = function() {
    ...
    while (!pos.isEmpty() && ((cur = this.domCursorForCaret()).firstText().equals(start || !cur.node.isContentEditable))) {
      pos = pos.forwardChar();
      if (pos.node.length === pos.pos) {
        pos = pos.next();
      }
      pos.moveCaret();
    }
