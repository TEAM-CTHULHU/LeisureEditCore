...
var BS, BasicEditingOptions, DEL, DOWN, DataStore, DataStoreEditingOptions, END, ENTER, HOME, LEFT, LeisureEditCore, Observable, PAGEDOWN, PAGEUP, RIGHT, TAB, UP, _to_ascii, blockText, defaultBindings, getEventChar, htmlForNode, idCounter, isEditable, keyFuncs, last, link, maxLastKeys, modifiers, modifyingKey, rangeContainsRange, root, selectRange, shiftKey, shiftUps, specialKeys,
  slice = [].slice,
  ...
  LeisureEditCore.prototype.getSelectedBlockRange = function() {
    ...
    if (s.type === 'None') {
      ...
      return {
        ...
        offset: this.getTextPosition(startHolder, s.anchorNode, s.anchorOffset),
        length: this.selectedText(s).length
      };
    }
  };
  ...
  LeisureEditCore.prototype.bind = function() {
    ...
    this.node.on('dragstart', (function(_this) {
      return function(e) {
        ...
        sel = getSelection();
        if (sel.type === 'Range') {
          _this.dragRange = _this.getSelectedBlockRange();
...
rangeContainsRange = function(r1, r2) {
  return r1.compareBoundaryPoints(Range.START_TO_START, r2) <= 0 && r2.compareBoundaryPoints(Range.END_TO_END, r1) <= 0;
};
